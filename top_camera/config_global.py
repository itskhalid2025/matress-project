...
Updated for Raspberry Pi Global Shutter Camera (IMX296).
"""

# ==============================================================================
# Camera & Resolution Tunables
# ==============================================================================
# The default webcam device index (e.g. /dev/video0). 
CAM_INDEX = 0

# Enforced capture resolution for the Global Shutter Camera.
# Max native resolution is exactly 1456 x 1088.
CAPTURE_W = 1456
CAPTURE_H = 1088
...
# *Note: Scaled proportionally from 1080p to fit the 1456x1088 sensor bounds!
FIXED_CROP = (150, 936, 227, 1228)
