...
def save_full_inspection_record(raw_qr_frame, raw_bill_frame, raw_top_frame,
    ...
    record = {
        ...
        "dimension_status": verification_res["dimension_status"],
        "product_variety": qr_data.get("product_name", "N/A"),
        "item_id": qr_data.get("inventory_item_id", "N/A"),
        ...
        "top_camera_data": {
            "measured_dimensions": verification_res["measured_dimensions"],
            "expected_dimensions": verification_res["expected_dimensions"],
